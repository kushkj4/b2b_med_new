...
export default function Sidebar({ role, isOpen, onClose }: SidebarProps) {
    ...
    return (
        <>
            ...
            <aside
                className={`fixed top-0 left-0 z-50 h-full w-64 bg-white border-r border-gray-200 shadow-sm transform transition-transform duration-300 ease-in-out lg:translate-x-0 ${isOpen ? 'translate-x-0' : '-translate-x-full'
                    }`}
            >
                {/* Logo */}
                ...
                <div className="px-6 py-3 border-b border-gray-100">
                    <span className={`inline-flex px-3 py-1 text-xs font-medium rounded-full ${role === 'admin'
                        ...
                        return (
                            <Link
                                ...
                                className={`flex items-center gap-3 px-4 py-2.5 rounded-lg transition-all text-sm ${isActive
                                        ? 'bg-blue-50 text-blue-700 font-medium border-l-4 border-blue-600 -ml-px'
                ...
                <div className="absolute bottom-0 left-0 right-0 p-4 border-t border-gray-100">
                    <div className="bg-gray-50 rounded-lg p-3">
                        <p className="text-xs text-gray-500">MedB2B Platform</p>
